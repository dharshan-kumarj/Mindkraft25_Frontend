...
const LoginPage: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Login Container (Glassmorphism Effect) */}
      <div className="bg-white bg-opacity-10 backdrop-blur-md border border-white border-opacity-20 shadow-lg rounded-lg p-8 w-96 flex flex-col items-center text-center">
        ...
        <form className="w-full mt-6" onSubmit={handleLogin}>
          <input
            ...
            required
            className="w-full mb-4 p-3 rounded border border-white border-opacity-30 bg-transparent text-white placeholder-white placeholder-opacity-70 focus:outline-none focus:ring-2 focus:ring-blue-400"
            value={email}
        ...
        <div className="w-full flex justify-between mt-4 text-sm">
          ...
          <a href="forgotpassword.html" className="text-blue-400 hover:underline">
            Forgot password?
          </a>
        </div>
      </div>
